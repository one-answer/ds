...
STRATEGIES: dict[str, dict[str, Any]] = {
    "ma_crossover": {
        ...
        "param_labels": {"fast": "Fast MA", "slow": "Slow MA"},
        "param_labels_zh": {"fast": "短期均线", "slow": "长期均线"},
        "param_help": {
            "fast": "Short moving average window.",
            "slow": "Long moving average window (must be > fast).",
        },
        "param_help_zh": {
            "fast": "短期均线窗口。",
            "slow": "长期均线窗口（需大于短期）。",
        },
        "param_range": {"fast": [3, 50], "slow": [10, 200]},
        "param_presets": {
            "conservative": {"fast": 20, "slow": 60},
            "balanced": {"fast": 10, "slow": 30},
            "aggressive": {"fast": 5, "slow": 20},
        },
        "param_presets_zh": {
            "conservative": {"name": "稳健", "params": {"fast": 20, "slow": 60}},
            "balanced": {"name": "均衡", "params": {"fast": 10, "slow": 30}},
            "aggressive": {"name": "激进", "params": {"fast": 5, "slow": 20}},
        },
    ...
    "rsi_reversion": {
        ...
        "param_help": {
            ...
            "buy_below": "Long when RSI <= this.",
            "sell_above": "Short when RSI >= this.",
            "exit_level": "Exit when RSI crosses this.",
        },
        "param_help_zh": {
            "period": "RSI 计算窗口。",
            "buy_below": "RSI 低于该值做多。",
            "sell_above": "RSI 高于该值做空。",
            "exit_level": "RSI 回到该值附近离场。",
        },
        "param_range": {
            "period": [5, 30],
            "buy_below": [10, 40],
        ...
        "param_presets": {
            "conservative": {"period": 20, "buy_below": 25, "sell_above": 75, "exit_level": 50},
            "balanced": {"period": 14, "buy_below": 30, "sell_above": 70, "exit_level": 50},
            "aggressive": {"period": 9, "buy_below": 35, "sell_above": 65, "exit_level": 50},
        },
        "param_presets_zh": {
            "conservative": {"name": "稳健", "params": {"period": 20, "buy_below": 25, "sell_above": 75, "exit_level": 50}},
            "balanced": {"name": "均衡", "params": {"period": 14, "buy_below": 30, "sell_above": 70, "exit_level": 50}},
            "aggressive": {"name": "激进", "params": {"period": 9, "buy_below": 35, "sell_above": 65, "exit_level": 50}},
        },
    ...
    "donchian_breakout": {
        ...
        "param_labels": {"entry": "Entry channel", "exit": "Exit channel"},
        "param_labels_zh": {"entry": "入场通道", "exit": "退出通道"},
        "param_help": {
            "entry": "Lookback window for breakout entry.",
            "exit": "Shorter window for exit signal.",
        },
        "param_help_zh": {
            "entry": "突破入场的回看窗口。",
            "exit": "退出信号的较短窗口。",
        },
        "param_range": {"entry": [10, 80], "exit": [5, 40]},
        "param_presets": {
            "conservative": {"entry": 40, "exit": 20},
            "balanced": {"entry": 20, "exit": 10},
            "aggressive": {"entry": 10, "exit": 5},
        },
        "param_presets_zh": {
            "conservative": {"name": "稳健", "params": {"entry": 40, "exit": 20}},
            "balanced": {"name": "均衡", "params": {"entry": 20, "exit": 10}},
            "aggressive": {"name": "激进", "params": {"entry": 10, "exit": 5}},
        },
    ...
    "adaptive_reversion": {
        ...
        "param_help": {
            "fast": "Fast MA window.",
            "slow": "Slow MA window.",
            "band_k": "Stddev band multiplier.",
            "trend_thresh": "Minimum trend strength.",
            "rsi_period": "RSI lookback window.",
            "rsi_buy": "Long when RSI below this.",
            "rsi_sell": "Short when RSI above this.",
            "exit_level": "Exit threshold.",
            "stop_loss_pct": "Stop loss in percent.",
            "take_profit_pct": "Take profit in percent.",
        ...
        "param_presets_zh": {
            "conservative": {"name": "稳健", "params": {
                "fast": 30, "slow": 120, "band_k": 1.8, "trend_thresh": 0.008,
                "rsi_period": 14, "rsi_buy": 35, "rsi_sell": 65, "exit_level": 50,
                "stop_loss_pct": 1.0, "take_profit_pct": 2.0, "max_hold_bars": 144,
            }},
            "balanced": {"name": "均衡", "params": {
                "fast": 20, "slow": 80, "band_k": 1.5, "trend_thresh": 0.006,
                "rsi_period": 14, "rsi_buy": 35, "rsi_sell": 65, "exit_level": 50,
                "stop_loss_pct": 1.2, "take_profit_pct": 2.5, "max_hold_bars": 96,
            }},
            "aggressive": {"name": "激进", "params": {
                "fast": 15, "slow": 60, "band_k": 1.3, "trend_thresh": 0.005,
                "rsi_period": 10, "rsi_buy": 40, "rsi_sell": 60, "exit_level": 50,
                "stop_loss_pct": 1.5, "take_profit_pct": 4.0, "max_hold_bars": 72,
            }},
        },
        "defaults": {
            "fast": 20,
